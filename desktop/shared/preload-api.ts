...
export const api = {
  ...
  job: {
    ...
    // Background dispatcher hooks. `create` already wakes the dispatcher,
    // so `dispatch` is a safety net; `dispatchNext` is the explicit "I'm
    // back, drain it" affordance for a renderer that just regained focus
    // after long idle.
