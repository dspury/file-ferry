# File Ferry Full App Implementation Plan
...
[`FILE-FERRY-PRODUCT-DIRECTION.md`](./FILE-FERRY-PRODUCT-DIRECTION.md). The
...
- Development runs `python -m file_ferry.service`; packaged builds launch a
