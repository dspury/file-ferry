# File Ferry Product Direction — Local Media Intake Workstation
...
Ferry v0.2.4 is a local CLI and Textual TUI for probing, organizing,
...
> **Ferry tells a small production what media exists, where it lives,
> whether it is safe, and what it is ready for.**

Ferry should serve solo creators and small post-production teams who work
...
receipt, and may enqueue proxy generation afterward. Ferry must never say
...
Ferry compares known project media against filesystem reality. It surfaces
...
| **Source** | A card, mounted volume, or selected folder supplied to Ferry. |
