...
ferry v0.2.4 is a Python CLI + Textual TUI. The vNext direction
(`docs/FERRY-PRODUCT-DIRECTION.md`) calls for a local-first
...
Python sidecar (run as `python -m ferry.service` in development,
...
- `docs/FERRY-FULL-APP-IMPLEMENTATION-PLAN.md` §5.1, §5.2, §8
- `docs/FERRY-PRODUCT-DIRECTION.md` §7, §8
