...
**Frozen layout** (relative to `src/file_ferry/`):
...
│   ├── cli.py                  # `python -m file_ferry.service`
...
client (`file_ferry.service.client.ApplicationClient`) to invoke
...
- `docs/FILE-FERRY-FULL-APP-IMPLEMENTATION-PLAN.md` §5.2, §9
- `docs/FILE-FERRY-PRODUCT-DIRECTION.md` §8
