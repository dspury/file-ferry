...
from ferry.application.policies import StoragePolicy
from ferry.application.replicas import ReplicaService, evaluate_gate
from ferry.application.sources import _volume_fingerprint
from ferry.persistence.connection import transaction
from ferry.persistence.repositories import intake as intake_repo
from ferry.persistence.repositories import projects as project_repo
from ferry.persistence.repositories import sources as source_repo
from ferry.persistence.repositories.intake import IntakeDestinationRow, IntakeSessionRow
    ...
    def create_session(self, params: CreateIntakeSessionParams) -> IntakeSession:
        ...
        with transaction(self._db_path) as conn:
            if project_repo.get_project(conn, params.project_id) is None:
                from ferry.application.projects import ProjectNotFoundError
