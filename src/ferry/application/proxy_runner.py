...
Wraps the legacy ``ferry.proxy`` capability as a scheduler runner so
...
from ferry.service.protocol import JobDetail
...
def default_proxy_fn(source_path: str, output_path: str) -> object:
    ...
    from ferry.models import ProxyRequest
    from ferry.proxy import generate_proxy
