...
The legacy ``ferry.drives.list_external_drives`` is the mount-point
...
from ferry.drives import list_external_drives
from ferry.service.protocol import MountedVolume
