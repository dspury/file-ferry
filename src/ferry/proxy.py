...
from ferry.probe import _format_errors, is_system_artifact
...
def _probe_output_metadata(output: Path) -> tuple[int, int, float]:
    ...
    """
    try:
        from ferry.probe import find_ffprobe, probe_file
...
def generate_proxies(
    ...
    from ferry.probe import ProbeError, find_ffprobe, probe_file
