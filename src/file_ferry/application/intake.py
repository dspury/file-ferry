...
from file_ferry.persistence.repositories import intake as intake_repo
...
from file_ferry.persistence.repositories.intake import IntakeDestinationRow, IntakeSessionRow
    ...
    def create_session(self, params: CreateIntakeSessionParams) -> IntakeSession:
        ...
        with transaction(self._db_path) as conn:
            if project_repo.get_project(conn, params.project_id) is None:
                from file_ferry.application.projects import ProjectNotFoundError
