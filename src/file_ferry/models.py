"""Pydantic models for ferry.

These models define the shape of data flowing through ferry:
- Input/output schemas for each capability (probe, organize, proxy, resolve, verify)
- Schema for the on-disk config file (ferry.toml)
...
# ---------------------------------------------------------------------------
# Top-level config (ferry.toml)
# ---------------------------------------------------------------------------


class FerryConfig(BaseModel):
    """Top-level ferry configuration loaded from file_ferry.toml."""
