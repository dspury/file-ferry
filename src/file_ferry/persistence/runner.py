...
Migrations are modules under :mod:`file_ferry.persistence.migrations`,
...
from file_ferry.persistence.connection import database_exists, open_connection
from file_ferry.persistence.schema_meta import (
    current_version,
    ensure_schema_meta,
    set_version,
)
...
def discover_migrations(pkg: object = None) -> list[Migration]:
    ...
    The default package is :mod:`file_ferry.persistence.migrations`;
    ...
    """
    if pkg is None:
        pkg = importlib.import_module("file_ferry.persistence.migrations")
    out: list[Migration] = []
