...
from file_ferry.models import FerryConfig, MediaProbe, ProbeRecord, RunStatus
...
def find_ffprobe(config: FerryConfig | None = None) -> str:
        ...
        try:
            ...
            store.insert_probe(
                ProbeRecord(
                    ...
                    audio_bit_depth=probe.audio_bit_depth,
                    duration=probe.duration_seconds,
                    modification_time=probe.modification_time,
